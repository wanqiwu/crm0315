...
<body class="main">
	<form action="${ctp }/plan/list" method="post">
		...
		<c:if test="${page != null && page.totalElements > 0 }">
					...
					<tr>
						...
						<td class="list_data_op">
							<c:if test='${chance.status==2}'>
								...
								<img 
									onclick="window.location.href='${ctp }/chance/finish?id=${chance.id}'"
									title="开发成功" src="${ctp }/static/images/bt_yes.gif" class="op_button" />
							</c:if>
							<c:if test='${chance.status!="2"}'>
								<img
									onclick="window.location.href='${ctp }/chance/detail?id=${chance.id}'"
			...
			<atguigu:page page="${page}" queryString="" list="/plan/list"/>
